...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
	<h1>Are You Sure You Want To Delete This Employee?</h1>
		...
		<table>
			...
			<tr>
				<td>User Category</td>
				<td><input type="text" name="uCategory" class="text" value="<%= uCategory%>" disabled></td>
			</tr>
			...
			<tr>
				<td>Password</td>
				<td><input type="text" name="psw" class="text" value="<%= password%>" disabled></td>
			</tr>
			<tr>
				<td><input type="submit" name="submit" class="submit"  value="Remove Employee"/> </td>
			</tr>
		</table>
	</form>
<!-- End Page Content -->
